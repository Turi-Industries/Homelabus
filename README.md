...
| `hlb-engine` — exécuteur + **réconciliation** (§2.1) | ✅ 22 tests |
...
| `hlb-backup` — restic, pg_dump, ordonnancement, vérification, **PITR** | ✅ 62 + 14 tests |
...
**444 tests unitaires + 49 tests d'intégration** (ces derniers `#[ignore]`, ils exigent Docker).
